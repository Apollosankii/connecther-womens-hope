/** Mirrors Android `TermsActivity` companion strings (ConnectHer). */

export const PRIVACY_POLICY_ONLINE_URL =
  'https://docs.google.com/document/d/1Xd6eqWVaJEkzaMQlHH6wLDCoAsB2ltUFPhQHHOJH61E/preview';

export const TERMS_TEXT = `1. Acceptance of Terms
...
6. Payments
Where applicable, payments are subject to the relevant payment provider’s terms. ConnectHer is not liable for payment disputes between users and third-party payment providers.
...
export const PRIVACY_TEXT = `1. Information We Collect
...
We share data only as necessary:
  ...
  • With payment providers for transaction processing (where applicable).
