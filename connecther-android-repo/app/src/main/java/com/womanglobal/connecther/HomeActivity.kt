...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!sharedPreferences.getBoolean("isLoggedIn", false)) {
            ...
            startActivity(Intent(this, com.womanglobal.connecther.auth.EmailPasswordAuthActivity::class.java))
            finish()
            return
        }
       ...
       // Initialize ViewPager with the appropriate adapter
        ...
        // Register FCM token with Supabase (Firebase ID token on requests)
